...
import { Bug, Mail, Lock, User, Chrome } from "lucide-react";
  ...
  const handleSignup = async (data: SignupFormData) => {
    ...
    if (error) {
      ...
      toast({ 
        ...
        description: "Welcome to IssueTrack." 
      });
      navigate("/dashboard");
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-foreground">IssueTrack</h1>
          <p className="text-muted-foreground">Issue Reporting & Feedback Platform</p>
        </div>
            ...
            <TabsContent value="signup">
              <form onSubmit={signupForm.handleSubmit(handleSignup)}>
                <CardHeader>
                  ...
                  <CardDescription>Get started with IssueTrack today</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          Want to submit anonymous feedback?{" "}
